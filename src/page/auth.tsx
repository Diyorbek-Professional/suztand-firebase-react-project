...
const Auth = () => {
  ...
  <form className="m-auto w-50" onSubmit={onSubmit}>
    ...
    <button className="btn btn-primary w-100 mt-2 py-2" type="submit" disabled={isLoading}>
    ...
    <p className="mt-2 fw-bold">
      ...
      {auth == 'signup' ? (
        <span className="fw-normal text-primary" onClick={() => toggleAuth('signin')} style={{ cursor: 'pointer' }}>Sign in</span>
      ) : (
